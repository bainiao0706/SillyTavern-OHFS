...
7.返回App页面，等待其从build变成starting，然后点击右上角的三个点，再点击Attached volumes的挂载盘跳转到储存页面。
<img width="2736" height="1543" alt="image" src="https://github.com/user-attachments/assets/b64f259d-6df7-49ab-af23-e4d289b3ad9b" />

8.进入挂载盘后查看git sillytavern的文件是否已经齐全，齐全则寻找到config.yaml文件删除然后在文件右边点击上传本仓库中的config.yaml文件，上传完成后打开编辑用户名与密码。
<img width="1756" height="1518" alt="image" src="https://github.com/user-attachments/assets/7e714ca9-56c3-4c5d-b4e6-ffc22715c67b" />

9.返回app页面先重启实例再点击embed this space，然后复制直连链接就可以游玩啦~
<img width="597" height="786" alt="image" src="https://github.com/user-attachments/assets/fc3b36ee-5847-46d2-bb71-16a0abdea577" />
...
>
> **Q.** 怎么找到酒馆文件？
> **A.** 位于挂载盘中，看步骤7，管理方法与本地部署一样。
>
> **Q.** Space设置为私人会怎么样？
> **A.** 如果你有域名并拿到了token令牌你可以通过cloudflare转发到你的域名上。
>
> **Q.** 我担心我的数据泄露了，怎么办？
> **A.** 目前所使用的是挂载盘挂载全部酒馆文件而且设置为私人，除了你与拥有token令牌的人均无权限访问。
